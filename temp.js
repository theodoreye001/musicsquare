  ...
  (function(){
    ...
    function init(){
      ...
      try { setupDOM(); } catch(e) { console.error('setupDOM failed', e); }
      try {
        const lg=localStorage.getItem('pikachu-music-lang'); 
        if(lg)state.language=lg;
      } catch(e){}
      
      try { setupParticles(); } catch(e) { console.error('setupParticles failed', e); }
      try { setupRipple(); } catch(e) { console.error('setupRipple failed', e); }
      try { setupEvents(); } catch(e) { console.error('setupEvents failed', e); }
